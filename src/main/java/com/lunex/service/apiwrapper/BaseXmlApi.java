...
public class BaseXmlApi extends BaseApi {
	...
	public <T> T get(String path, Map<String, String> queryParams, 
		...
		Response response = this.getInvocationBuilder(path, MediaType.TEXT_XML, queryParams).get();
	...
	public <T1, T2> T1 post(String path, Map<String, String> queryParams, 
		...
		Response response = this.getInvocationBuilder(path, MediaType.TEXT_XML, queryParams)
