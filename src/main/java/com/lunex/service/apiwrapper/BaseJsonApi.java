...
public class BaseJsonApi extends BaseApi {
	...
	public <T> T get(String path, Map<String, String> queryParams, 
		...
		Response response = this.getInvocationBuilder(path, MediaType.APPLICATION_JSON, queryParams).get();
	...
	public <T1, T2> T1 post(String path, Map<String, String> queryParams, 
		...
		Response response = this.getInvocationBuilder(path, MediaType.APPLICATION_JSON, queryParams)
